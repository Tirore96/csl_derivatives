...
Makefile.conf: _CoqProject
	coq_makefile -f _CoqProject theories/ContractEquations.v theories/Contract.v theories/EagerContract.v theories/Order.v theories/PSContract.v -o Makefile
