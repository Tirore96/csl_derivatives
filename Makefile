...
Makefile.conf: _CoqProject
	coq_makefile -f _CoqProject theories/ContractEquations.v theories/Contract.v theories/NormalizedParallelContract.v theories/Order.v theories/ParallelContract.v theories/PlusFold.v -o Makefile
