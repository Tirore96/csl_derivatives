...
| CPar : Contract -> Contract -> Contract.
...
| c0 _||_ c1 => e \ c0 _||_ c1 _+_ c0 _||_ e \ c1 
end
...
| Trace_Derive_Cons c s c' e (H: Trace_Derive (e \ c) s c') : Trace_Derive c (e::s) c'. (*rule motivated by constructor being analgous to cons on lists*)
...
Reserved Notation "s \\ c" (at level 42, left associativity).
