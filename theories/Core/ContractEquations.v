...
Theorem Matches_iff_member : forall s c, s =~ c <-> In s (monoms c).
Proof.
...
Lemma incl_Matches : forall (c0 c1 : Contract), incl (monoms c0) (monoms c1) -> 
...
incl (monoms c0) (monoms c1) /\ incl (monoms c1) (monoms c0) .
Proof.
split;intros.
